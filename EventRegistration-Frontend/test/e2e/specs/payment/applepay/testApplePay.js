...
var testData = {
        'validPaymentData': {
                'personName': 'Percy-applePay',
                'eventName': 'Soccer-applePay',
        ...
        'InvalidIdTestData': {
                'personName': 'Percy1-applePay',
                'eventName': 'Soccer1-applePay',
                'startDate': '12/04/2019',
                'startTime': '8:00 AM',
                'endDate': '10:00 AM',
                'amount': '100',
        ...
        'InvalidAmountTestData': {
                'personName': 'Percy2-applePay',
                'eventName': 'Soccer2-applePay',
                'startDate': '12/04/2019',
                'startTime': '8:00 AM',
                'endDate': '10:00 AM',
                'amount': '-100',
                ...
                'personName': 'Percy3-applePay',
                'eventName': 'Soccer3-applePay',
                'startDate': '12/04/2019',
                'startTime': '8:00 AM',
                'endDate': '10:00 AM',
                'amount': '100',
                'deviceID': '1235-ADFD',
                'newDeviceID': '9999-ZZZZ',
                'newAmount': '200'
        }
}
module.exports = {
  'Test Apple Pay: 01 Component Existance': function (browser) {
    browser
        .url(config.url)
    ...
    'Test Apple Pay: 02 Valid Payment': function (browser) {
        browser
        .url(config.url)
        .waitForElementVisible('body', 1000).pause(1000);
        ...
        browser.setValue(config.componentIDs.personField, testData.validPaymentData.personName)
               .click(config.componentIDs.personButton).pause(2000);
        ...
        browser.setValue(config.componentIDs.eventField, testData.validPaymentData.eventName)
                ...
                .click(config.componentIDs.eventButton).pause(2000);
        ...
        browser.setValue(config.componentIDs.registrationEvent, testData.validPaymentData.eventName)
                ...
                .click(config.componentIDs.registrationButton).pause(2000);
        ...
        browser.getText(config.componentIDs.registrationTable, function (result) {
                ...
                browser.setValue(config.componentIDs.paymentEvent, testData.validPaymentData.eventName)
                        .setValue(config.componentIDs.paymentId, testData.validPaymentData.deviceID)
                ...
                browser.getText(config.componentIDs.registrationTable, function (result) {
                    ...
                    var containID = diff.indexOf(testData.validPaymentData.deviceID.toLowerCase().replace(/\s/g, '')) >= 0;
    ...
    'Test Apple Pay: 03 Invalid ID': function (browser) {
        browser
        .url(config.url)
        ...
        browser.getText(config.componentIDs.registrationTable, function (result) {
            ...
            browser.setValue(config.componentIDs.paymentEvent, testData.InvalidIdTestData.eventName)
                    .setValue(config.componentIDs.paymentId, testData.InvalidIdTestData.deviceID)
    ...
    'Test Apple Pay: 04 Invalid Amount': function (browser) {
        browser
        .url(config.url)
        .waitForElementVisible('body', 1000).pause(2000);
        // step1: add a person
        ...
        browser.getText(config.componentIDs.registrationTable, function (result) {
            ...
            browser.setValue(config.componentIDs.paymentEvent, testData.InvalidAmountTestData.eventName)
                    .setValue(config.componentIDs.paymentId, testData.InvalidAmountTestData.deviceID)
    ...
    'Test Apple Pay: 05 Update Payment': function (browser) {
        browser
        .url(config.url)
        .waitForElementVisible('body', 1000).pause(2000);
        // step1: add a person
        ...
        browser.getText(config.componentIDs.registrationTable, function (result) {
                ...
                browser.setValue(config.componentIDs.paymentEvent, testData.TestUpdatePaymentData.eventName)
                        .setValue(config.componentIDs.paymentId, testData.TestUpdatePaymentData.deviceID)
                ...
                browser.setValue(config.componentIDs.paymentPerson, testData.TestUpdatePaymentData.personName)
                        ...
                        .setValue(config.componentIDs.paymentId, testData.TestUpdatePaymentData.newDeviceID)
                ...
                browser.getText(config.componentIDs.registrationTable, function (result) {
                    ...
                    var diff = newText.replace(originalText, '');
                    // check existance of data
                    var containID = diff.indexOf(testData.TestUpdatePaymentData.newDeviceID.toLowerCase().replace(/\s/g, '')) >= 0;
